...
class OrgsorgidprojectsprojectidbuildtargetsSettingsAdvancedUnityPlayerExporter(object):
    ...
    def export(self):
        ...
        Enable exporting a player from Unity (i.e. running BuildPipeline.BuildPlayer). In general, this should be true, unless you are doing something like an asset bundle only build or unit test only build without generating an actual build artifact.  # noqa: E501
